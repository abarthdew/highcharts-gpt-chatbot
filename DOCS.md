...
{: .prompt-info }
![Untitled](/assets/img/1(7).png)
_json코드 리턴(생략)_
![Untitled](/assets/img/1(8).png)
...
![Untitled](/assets/img/1(10).png)
_OVERLAP_버튼을_클릭했을_때_
![Untitled](/assets/img/1(11).png)
...
### 3. 버그/개선 목록
`2023/06/30`
- 동적 차트 일괄 변경되는 문제 -> append로 코드 변경 고려
